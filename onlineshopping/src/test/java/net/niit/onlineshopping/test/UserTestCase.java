...
import net.niit.onlineshopping.dao.UserDAO;
import net.niit.onlineshopping.dto.Address;
import net.niit.onlineshopping.dto.Cart;
...
public class UserTestCase {
	 ...
	 * 
	 * cart.setUser(user); // add the cart
	 ...
	 * address.setCity("Mumbai"); address.setState("Maharashtra");
	 * address.setCountry("India"); address.setPostalCode("400001"); // set
	...
	/*
	 * @Test public void testAdd() { user = new User() ; user.setFirstName("");
	 * user.setLastName("Roshan"); user.setEmail("hr@gmail.com");
	 * user.setContactNumber("1234512345"); user.setRole("USER");
	 * user.setPassword("123456");
	 * 
	 ...
	 * 
	 * // fetch the user by its email user = userDAO.getByEmail("hr@gmail.com");
	 * 
	 ...
	 * 
	 * // we need to add an user user = new User() ;
